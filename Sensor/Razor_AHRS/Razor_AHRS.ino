...
float ACCEL_X_MIN = -259;
float ACCEL_X_MAX = 257;
float ACCEL_Y_MIN = -249;
float ACCEL_Y_MAX = 262;
float ACCEL_Z_MIN = -263;
float ACCEL_Z_MAX = 245;

// Magnetometer (standard calibration mode)
// "magn x,y,z (min/max) = X_MIN/X_MAX  Y_MIN/Y_MAX  Z_MIN/Z_MAX"
float MAGN_X_MIN = -490;
float MAGN_X_MAX = 706;
float MAGN_Y_MIN = -748;
float MAGN_Y_MAX = 562;
float MAGN_Z_MIN = -533;
float MAGN_Z_MAX = 583;
...
float magn_ellipsoid_center[3] = {78.2404, -58.0372, 23.4409};
float magn_ellipsoid_transform[3][3] = {{0.911301, 0.00140244, -0.00896400}, {0.00140244, 0.893952, 0.0273382}, {-0.00896400, 0.0273382, 0.992118}};

// Gyroscope
// "gyro x,y,z (current/average) = .../OFFSET_X  .../OFFSET_Y  .../OFFSET_Z
float GYRO_AVERAGE_OFFSET_X = -19.34;
float GYRO_AVERAGE_OFFSET_Y = 15.83;
float GYRO_AVERAGE_OFFSET_Z = 34.31;
